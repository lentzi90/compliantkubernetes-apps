...
"${here}/.././bin/ck8s" ops helmfile wc destroy

# Clean up namespaces and any other resources left behind by the apps
"${here}/.././bin/ck8s" ops kubectl wc delete ns cert-manager falco fluentd gatekeeper gatekeeper-system ingress-nginx monitoring velero
